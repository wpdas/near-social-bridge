    ...
    return tslib_1.__generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            (0, request_1['default'])(constants_1.REQUEST_KEYS.SESSION_STORAGE_HYDRATE_VIEWER, _storage),
          ]
        case 1:
          // Hydrate the Viewer "sessionStorageClone" state with External App _storage object
          _a.sent()
    ...
    return tslib_1.__generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            (0, request_1['default'])(constants_1.REQUEST_KEYS.SESSION_STORAGE_HYDRATE_APP),
