...
export interface NavigationProps<S extends ParamListBase> {
     ...
     * @param args
     */
    push<RouteName extends keyof S>(...args: undefined extends S[RouteName] ? [screen: RouteName] | [screen: RouteName, params: S[RouteName]] : [screen: RouteName, params: S[RouteName]]): void;
    /**
...
export type IFrameStackNavigationProp<ParamListBase> = {
     ...
     * @param args
     */
    push<RouteName extends keyof ParamListBase>(...args: undefined extends ParamListBase[RouteName] ? [screen: RouteName] | [screen: RouteName, params: ParamListBase[RouteName]] : [screen: RouteName, params: ParamListBase[RouteName]]): void;
    /**
     * Go to the previous screen
     * @returns
     */
...
export declare type RouteProp<ParamList extends ParamListBase, RouteName extends keyof ParamList = Keyof<ParamList>> = Route<Extract<RouteName, string>>;
export declare type ScreenRouteProp<ParamList extends ParamListBase, RouteName extends keyof ParamList = Keyof<ParamList>> = ScreenRoute<Extract<RouteName, string>, ParamList[RouteName]>;
export declare type IFrameStackScreenProps<ParamList extends ParamListBase, RouteName extends keyof ParamList = string> = {
